...
@Api(value = "/member/meProfile", description = "Authentication", produces = "application/json")
@CrossOrigin
public class MeProfileController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Login Success", response = LoginDto.class),
			@ApiResponse(code = 500, message = "Internal Server Error"),
			@ApiResponse(code = 404, message = "Login Not Found") })
	@SuppressWarnings("unchecked")
	@GetMapping("/meProfile")
	public ResponseEntity<?> meProfileAction(Authentication auth) {
