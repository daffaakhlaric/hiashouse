...
public class HlsJobCreationSample {
    ...
    private static final String PIPELINE_ID = "540278410530-899cw3";
    
    // This is the name of the input key that you would like to transcode.
    private static final String INPUT_KEY = "original-video-source/test.mp4";
    ...
    private static final String OUTPUT_KEY_PREFIX = "segment-tech-video";
